...
bool st7701InitRegs(void)
{
	...
	st7701WriteCmd(0xB0);
	st7701WriteData(0x60); //Vop=4.7375v
	st7701WriteCmd(0xB1);
	st7701WriteData(0x32); //VCOM=32
	st7701WriteCmd(0xB2);
	st7701WriteData(0x07); //VGH=15v
	st7701WriteCmd(0xB3);
	st7701WriteData(0x80);
	st7701WriteCmd(0xB5);
	st7701WriteData(0x49); //VGL=-10.17v
	st7701WriteCmd(0xB7);
	st7701WriteData(0x85);
	st7701WriteCmd(0xB8);
	st7701WriteData(0x21); //AVDD=6.6 & AVCL=-4.6
	st7701WriteCmd(0xC1);
