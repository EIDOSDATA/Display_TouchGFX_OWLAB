...
void HAL_I2C_MspInit(I2C_HandleTypeDef *hi2c)
{
	...
	if (hi2c->Instance == I2C1)
	{
		...
		/**I2C1 GPIO Configuration
		 ...
		 PB7     ------> I2C1_SDA
		 */
		GPIO_InitStruct.Pin = TOUCH_I2C1_SCL_Pin | TOUCH_I2C1_SDA_Pin;
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef *hi2c)
{
	if (hi2c->Instance == I2C1)
	{
		...
		/**I2C1 GPIO Configuration
		 ...
		 PB7     ------> I2C1_SDA
		 */
		HAL_GPIO_DeInit(TOUCH_I2C1_SCL_GPIO_Port, TOUCH_I2C1_SCL_Pin);

		HAL_GPIO_DeInit(TOUCH_I2C1_SDA_GPIO_Port, TOUCH_I2C1_SDA_Pin);
...
void HAL_LTDC_MspDeInit(LTDC_HandleTypeDef *hltdc)
{
	if (hltdc->Instance == LTDC)
	{
		...
		HAL_GPIO_DeInit(GPIOJ, GPIO_PIN_1 | GPIO_PIN_2 | GPIO_PIN_3 | GPIO_PIN_4 | GPIO_PIN_5 | GPIO_PIN_6 | GPIO_PIN_7 | GPIO_PIN_8 | GPIO_PIN_9 | GPIO_PIN_10 | GPIO_PIN_11 | GPIO_PIN_12 | GPIO_PIN_13 | GPIO_PIN_14 | GPIO_PIN_15);

		HAL_GPIO_DeInit(GPIOK, GPIO_PIN_0 | GPIO_PIN_1 | GPIO_PIN_2 | GPIO_PIN_3 | GPIO_PIN_4 | GPIO_PIN_5 | GPIO_PIN_6 | GPIO_PIN_7);
...
void HAL_QSPI_MspInit(QSPI_HandleTypeDef *hqspi)
{
	...
	if (hqspi->Instance == QUADSPI)
	{
		...
		/*
		 * TODO : QSPI TEST
		 * 	#include "stm32h743i_eval_qspi.h" >> Unused
		 * 	#include "stm32f769i_eval_qspi.h" >> Used
		 * 	user_mem_qspi.c >> Check PLZ
		 * */
#if 1
...
void HAL_TIM_Encoder_MspInit(TIM_HandleTypeDef *htim_encoder)
{
	...
	if (htim_encoder->Instance == TIM4)
	{
		...
		/**TIM4 GPIO Configuration
		 ...
		 PD13     ------> TIM4_CH2
		 */
		GPIO_InitStruct.Pin = TIM4_CH2_ENCODER1_Pin | TIM4_CH2_ENCODER2_Pin;
		GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
		GPIO_InitStruct.Pull = GPIO_NOPULL;
		GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef *htim)
{
	...
	if (htim->Instance == TIM1)
	{
		...
		/**TIM1 GPIO Configuration
		 ...
		 PA10     ------> TIM1_CH3
		 */
		GPIO_InitStruct.Pin = TIM1_CATHODE_PWM_Pin;
		GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
		GPIO_InitStruct.Pull = GPIO_NOPULL;
		GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
		GPIO_InitStruct.Alternate = GPIO_AF1_TIM1;
		HAL_GPIO_Init(TIM1_CATHODE_PWM_GPIO_Port, &GPIO_InitStruct);

		GPIO_InitStruct.Pin = TIM1_ANODE_PWM_Pin;
		GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
		GPIO_InitStruct.Pull = GPIO_NOPULL;
		GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
		GPIO_InitStruct.Alternate = GPIO_AF1_TIM1;
		HAL_GPIO_Init(TIM1_ANODE_PWM_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef *htim_encoder)
{
	if (htim_encoder->Instance == TIM4)
	{
		...
		/**TIM4 GPIO Configuration
		 ...
		 PD13     ------> TIM4_CH2
		 */
		HAL_GPIO_DeInit(GPIOD, TIM4_CH2_ENCODER1_Pin | TIM4_CH2_ENCODER2_Pin);
