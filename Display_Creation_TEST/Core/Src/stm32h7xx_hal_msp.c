...
void HAL_LTDC_MspDeInit(LTDC_HandleTypeDef* hltdc)
{
  if(hltdc->Instance==LTDC)
  {
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOJ, GPIO_PIN_1|GPIO_PIN_2|GPIO_PIN_3|GPIO_PIN_4
                          |GPIO_PIN_5|GPIO_PIN_6|GPIO_PIN_7|GPIO_PIN_8
                          |GPIO_PIN_9|GPIO_PIN_10|GPIO_PIN_11|GPIO_PIN_12
                          |GPIO_PIN_13|GPIO_PIN_14|GPIO_PIN_15);
...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  */
    ...
    PC7     ------> USART6_RX
    */
    GPIO_InitStruct.Pin = CON_JF1_CON_J2_PC6_USART6_TX_Pin|CON_J2_PC7_USART6_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  if(huart->Instance==USART6)
  {
    ...
    PC7     ------> USART6_RX
    */
    HAL_GPIO_DeInit(GPIOC, CON_JF1_CON_J2_PC6_USART6_TX_Pin|CON_J2_PC7_USART6_RX_Pin);
